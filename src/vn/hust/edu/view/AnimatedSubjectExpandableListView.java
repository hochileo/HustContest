 ...
 */
public class AnimatedSubjectExpandableListView extends ExpandableListView {
    ...
    public AnimatedSubjectExpandableListView(Context context) {
        super(context);
    }

    public AnimatedSubjectExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AnimatedSubjectExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private AnimatedSubjectExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(AnimatedSubjectExpandableListView parent) {
            this.parent = parent;
        }
